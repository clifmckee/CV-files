...
%In review & A Islam, \textbf{C McKee}, PK Ghosh, J Abedin, JH Epstein, P Daszak, SP Luby, SU Khan, ES Gurley. Seasonality of bats' date palm sap feeding behavior in an area of Bangladesh associated with Nipah virus spillover. \textcolor{special}{EcoHealth}.\\
%
%In review & AD Redd, LS Peetluk, BA Jarrett, C Hanrahan, S Schwartz, A Rao, AE Jaffe, CB Jones, CS Lutz, \textbf{C McKee}, EU Patel, JG Rosen, H Garrison-Desany, H McKay, J Muschelli, K Anderson, MA Link, N Wada, P Baral, R Young, D Boon, MK Grabowski, ES Gurley. Curating and translating the evidence about SARS-CoV-2 and COVID-19 for frontline public health and clinical care: The Novel Coronavirus Research Compendium (NCRC). \textcolor{special}{Public Health Reports}.\\
%
%In press & VO Zorrilla, ME Lozano, LJ Espada, M Kosoy, \textbf{C McKee}, HO Valdivia, H Arevalo, M Troyes, CA Stoops, ML Fisher, GM Vasquez. Comparison of sand fly trapping approaches for vector surveillance of \textit{Leishmania} and \textit{Bartonella} species in ecologically distinct, endemic regions of Peru. \textcolor{special}{PLOS Neglected Tropical Diseases}.\\
