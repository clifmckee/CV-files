...
\item \textbf{McKee CD}\textsuperscript{*}, Webb CT, Kosoy MY, Suu-Ire R, Ntiamoa-Baidu Y, Cunningham AA, Wood JLN, Hayman DTS. Manipulating vector transmission reveals local processes in \textit{Bartonella} communities of bats. \textit{Accepted at Parasitology}.

\item Jones BD, Falvo CA, Burwell C, Lunn TJ, Jones-Slobodian DN, Benson E, \textbf{McKee CD}, Rynda-Apple A, Plowright RK, Becker DJ, Clark KL, McCallum H, Clark NJ, Peel AJ. Asynchronous seasonal dynamics of nycteribiid bat flies and \textit{Bartonella} spp. in Australian flying foxes (\textit{Pteropus} spp.). \textit{Accepted at Parasites \& Vectors}.

\item Crowley D, Falvo C, Grant C, Borremans B, Lunn T, Ruiz-Aravena M, Benson E, \textbf{McKee C}, Becker D, Jones D, Bushmaker T, Yu Y, Michie M, Dale A, Yan L, Sterling S, Broder C, Goodman L, Petraitytė-Burneikienė R, Laing E, Smith I, Munster V, Rynda-Apple A, Peel A, Plowright R. Cohorts of immature \textit{Pteropus} bats show interannual variation in Hendra virus serology. \textit{In press at Journal of Animal Ecology}.
