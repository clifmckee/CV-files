...
\item \textbf{McKee CD}\textsuperscript{*}, Webb CT, Kosoy MY, Suu-Ire R, Ntiamoa-Baidu Y, Cunningham AA, Wood JLN, Hayman DTS. Manipulating vector transmission reveals local processes in \textit{Bartonella} communities of bats. \textit{Parasitology}. 2026. \href{https://doi.org/10.1017/S0031182026101656}{10.1017/S0031182026101656}

\item Crowley DE, Falvo CA, Grant CK, Borremans B, Lunn TJ, Ruiz-Aravena M, Benson E, \textbf{McKee CD}, Becker DJ, Jones DN, Bushmaker T, Tina Yu Y, Michie M, Dale AS, Yan L, Sterling SL, Broder CC, Goodman LB, Petraityte-Burneikiene R, Laing ED, Smith IL, Munster VJ, Rynda-Apple A, Peel AJ, Plowright R. Cohorts of immature \textit{Pteropus} bats show interannual variation in Hendra virus serology. \textit{Journal of Animal Ecology}. 2026. DOI: \href{http://doi.org/10.1111/1365-2656.70213}{10.1111/1365-2656.70213}

\item Jones BD, Falvo CA, Burwell C, Lunn TJ, Jones-Slobodian DN, Benson E, \textbf{McKee CD}, Rynda-Apple A, Plowright RK, Becker DJ, Clark KL, McCallum H, Clark NJ, Peel AJ. Asynchronous seasonal dynamics of nycteribiid bat flies and \textit{Bartonella} spp. in Australian flying foxes (\textit{Pteropus} spp.). \textit{Parasites \& Vectors}. 2026. DOI: \href{https://doi.org/10.1186/s13071-026-07243-1}{10.1186/s13071-026-07243-1}

\item Šikutová S\textsuperscript{\dag}, Mravcová K\textsuperscript{\dag}, Mendel J, Šebesta O, Sak B, Holubová N, Kváč M, \textbf{McKee C}, Adler PH, Otranto D, Rudolf I. Molecular screening of black flies (Diptera: Simuliidae) for vector‐borne zoonotic pathogens, South Moravia, Czech Republic. \textit{Zoonoses and Public Health}. 2026; 73(1): 95--106. DOI: \href{https://doi.org/10.1111/zph.70031}{10.1111/zph.70031}

\item Loo SL, Jung SM Contamin L, Howerton E, Bents SJ, Hochheiser H, Runge MC, Smith CP, Carcelén EC, Yan K, Lemaitre JC, …, \textbf{McKee C}, …,  Shea K, Viboud C, Lessler J, Truelove S. Scenario projections of COVID-19 burden in the US, 2024-2025. \textit{JAMA Network Open}. 2025; 8(9): e2532469. DOI: \href{https://doi.org/10.1001/jamanetworkopen.2025.32469}{10.1001/jamanetworkopen.2025.32469}

\item Bradburne C, Islam A, Bird I, Abbott E, Harrison S, Chunn M, Radune D, Hasan MR, Janes B, Lovett S, Lagergren J, O'Hanlon T, Debnath K, \textbf{McKee C}, Hossain ME, Gallagher M, Jacobson D, Rahman MZ, Caviness K, Plowright RK, Gurley ES. Genomic surveillance detection of SARS-CoV-1--like viruses in Rhinolophidae bats, Bandarban Region, Bangladesh. \textit{Emerging Infectious Diseases}. 2025; 31(8): 1652--1656. DOI: \href{https://doi.org/10.3201/eid3108.250071}{10.3201/eid3108.250071}

\item Schwantes CJ, Sánchez CA, Stevens T, Zimmerman R, Albery G, Becker DJ, Brookson CB, Kading RC, Keiser CN, Khandelwal S, Kramer-Schadt S, …, \textbf{McKee C}, …, Carlson CJ.  A minimum data standard for wildlife disease research and surveillance. \textit{Scientific Data}. 2025; 12: 1054. DOI: \href{https://doi.org/10.1038/s41597-025-05332-x}{10.1038/s41597-025-05332-x}

\item Verrett TB, Falvo CA, Benson E, Jones-Slobodian DN, Crowley DE, Dale AS, Lunn TJ, Ruiz-Aravena M, Rynda-Apple A, \textbf{McKee CD}, Clark KL, Gofton AW, Peel AJ, Plowright RK, Becker DJ, Bat One Health. \textit{Borrelia} lineages adjacent to zoonotic clades in black flying foxes (\textit{Pteropus alecto}), Australia, 2018–2020.  \textit{Emerging Infectious Diseases}. 2025; 37(7): 1415--1420. DOI: \href{https://doi.org/10.3201/eid3107.241864}{10.3201/eid3107.241864}
...
% \subsection*{Manuscripts Submitted or in Preparation}

% \begin{pubenum}

% \item Zorrilla VO\textsuperscript{\dag}, Carrazco-Montalvo A\textsuperscript{\dag}, Espada LJ, Fárez-Noblecilla LA, Lozano ME, Kosoy M, \textbf{McKee C}, Stoops CA, Larson R, Leon R, Vásquez GM. Phlebotomine sand fly fauna characterization and \textit{Bartonella bacilliformis} DNA detection in \textit{Pintomyia} (\textit{Pifanomyia}) \textit{robusta} at the Ecuador-Peru frontier. \textit{In revision at PLOS Neglected Tropical Diseases}.

% \item Debnath K, Sarker BR, Siddique SS, Rahman MA, Rahman MM, Noman ZA, Raquib A, Anisuzzaman A, \textbf{McKee C}, Islam A. Epidemiology of ectoparasites (tick, mite, lice, flea, and fly) in different domestic, peri-domestic, and wild animals in Bangladesh: a systematic review and meta-analysis. \textit{In review at Preventive Veterinary Medicine: Regional Studies and Reports}.
...
\href{https://insideclimatenews.org/news/23082025/climate-change-to-expand-fruit-bat-habitat-nipah-virus/}{Climate Change Likely to Expand the Range of an Asian Bat and the Deadly Disease it Carries} $\cdot$ Interview with \textit{Inside Climate News} (2025)
...
The One Health Approach to Epidemiology and Global Public Health (340.610.81) $\cdot$ Co-Instructor: Emily Gurley $\cdot$ Spring Fourth Term (2023--present, enrollment: 35--45)
...
Introduction to \texttt{R} for Public Health Researchers (140.604.79) $\cdot$ Summer Institute 2025 \\
The One Health Approach to Epidemiology and Global Public Health (340.610.81) $\cdot$ Spring Fourth Term 2024--2025 \\
...
Project Title: Environmental influences on Child Health Outcomes (ECHO) Data Analysis Center \\
Dates: 09/21/2016 -- 05/31/2030 \\
Sponsoring Agency: NIH Office of the Director \\
Principal Investigator: Lisa Jacobson \\
Contributions: Perform data retrieval and synthesis from existing child health data repositories; use appropriate biostatistics approaches to identify predictors of pediatric health outcomes, including spatial and microbiome data; assist with manuscript development and writing \\
...
Contributions: Lead recruitment and logistics for Applied Modeling in Public Health workshop series; assist with workshop content; participate in model development and software tools for forecasts and scenario projections of COVID-19, influenza, and RSV hospitalizations and deaths \\
Role: Research Associate
...
Contributions: Co-led the grant application and revisions; draft animal research protocols for IRB approval, collate and analyze data coming from the field and the laboratory, and lead development of manuscripts for publication \\
Role: Research Associate
...
Principal Investigator: Emily Gurley \\
Contributions: Co-led the grant application and revisions; draft animal research and human subjects protocols for IRB approval, collate and analyze data coming from the field and the laboratory, and lead development of manuscripts for publication \\
Role: Research Associate
...
Principal Investigator: Shaun Truelove \\
Contributions: Lead recruitment and logistics for Applied Modeling in Public Health workshop series; assist with workshop content; participate in model development for forecasts and scenario projections of COVID-19, influenza, and RSV cases and hospitalizations \\
Role: Research Associate
...
Contributions: Work with the team in Bangladesh to develop and implement protocols to sample bats, including identifying roosts best suited for sampling, ensuring protocols are aligned with broad aims of this grant, and that work is delivered on time; real-time analysis of virus detection data \\
...
Principal Investigator: Emily Gurley \\
Contributions: Support COVID-19 technical lead to improve evidence-based guidance by completing a systematic review of COVID-19 superspreading \\
Role: Postdoctoral Fellow
...
Bats, bugs, and biosurveillance: developing One Health systems to understand and prevent pathogen spillover $\cdot$ University of Connecticut Department of Pathobiology and Veterinary Science $\cdot$ Storrs, CT (2025)
...
Shared food resources between bats, humans, and domestic animals in Bangladesh with implications for viral spillover $\cdot$ North American Symposium on Bat Research $\cdot$ Edmonton, Canada (2025)
...
\textbf{Computing and Data Visualization}: High proficiency in R for data manipulation, statistical analysis, and visualization (base and tidyverse, ggplot2, igraph), generating reports with R Markdown, and interactive web pages with Shiny; proficiency with git, \LaTeX, and Python (NumPy, pandas, seaborn)
