...
Environmental and behavioral drivers of cross-species Nipah virus transmission in Bangladesh $\cdot$ 
...
Ecological stressors and pathogen shedding $\cdot$ Emerging Infectious Diseases: Ecology and Evolution workshop $\cdot$ International Centre for Theoretical Sciences $\cdot$ Bengaluru, India (2024)
...
Niu, Yannan $\cdot$ Master of Health Science, Epidemiology $\cdot$ Johns Hopkins Bloomberg School of Public Health (2023 -- 2024) $\cdot$ Thesis: Bat viral shedding: a review of seasonal patterns and risk factors (\textit{manuscript in preparation for submission to Vector-Borne and Zoonotic Diseases})
